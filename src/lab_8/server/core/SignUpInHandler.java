...
import lab_8.crypto.Mail;
import lab_8.message.Account;
import lab_8.message.loggingIn.AuthenticationRequest;
import lab_8.message.loggingIn.AuthenticationResponse;
import lab_8.message.loggingIn.IdentificationRequest;
import lab_8.message.loggingIn.IdentificationResponse;
import lab_8.message.registration.RegistrationRequest;
import lab_8.message.registration.RegistrationResponse;
...
import static lab_8.server.Database.accounts;
import static lab_8.server.Database.accountsSave;
